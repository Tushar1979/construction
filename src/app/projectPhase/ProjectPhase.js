...
const ProjectPhase = (props) => {
    ...
    return (
        ...
        <div>
            ...
            {display && <AddProjectPhase addProjectPhaseApi={addProjectPhaseApi} display={display} setdisplay={setdisplay} ProjectName={ProjectName} handleGetProjectPhaseApiCall={handleGetProjectPhaseApiCall}></AddProjectPhase>}
