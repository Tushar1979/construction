    ...
    return (
      <div>
        ...
        <div id="right-sidebar" className="settings-panel right-sidebar">
          ...
          <Tabs defaultActiveKey="TODOLIST" className="bg-gradient-info" id="uncontrolled-tab-example">
              ...
              <div>
                      ...
                      <div>
                        ...
                        <form  className="add-items d-flex" onSubmit={this.addTodo}>
                          <input 
                            ...
                            required />
                          <button type="submit" className="btn btn-gradient-info font-weight-bold">Add</button>
                        </form>
                ...
                <div className="events py-4 border-bottom px-3">
                  <div className="wrapper d-flex mb-2">
                    <i className="mdi mdi-circle-outline text-info mr-2"></i>
