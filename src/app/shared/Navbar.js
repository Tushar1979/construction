      ...
      <div className="navbar-menu-wrapper d-flex align-items-stretch">
        ...
        {userDetail?.designation === "Admin" || userDetail?.designation === "Superadmin" ?
          ...
          {/* <li className="nav-item nav-logout d-none d-lg-block">
            <a className="nav-link" onClick={WantToLogOut}>
            ...
            <Dropdown alignRight>
              <Dropdown.Toggle className="nav-link">
                ...
                <div className="nav-profile-img">
                  <img src={require("../../assets/images/faces-clipart/pic-1.png")} alt="user" />
              ...
              <Dropdown.Menu className="navbar-dropdown">
                <Dropdown.Item as={Link} to='/profile' >
                  <i className="mdi mdi-face-profile mr-2 text-success"></i>
                  Update Profile
                </Dropdown.Item>
                <Dropdown.Item onClick={WantToLogOut}>
